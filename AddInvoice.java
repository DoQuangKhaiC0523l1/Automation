...
import Interface.AddInvoiceInterface;
...
public class AddInvoice extends AbstractPage {
    ...
    public void selectValueInTime(String cbb,String value)  {
        clickToElement(driver,AddInvoiceInterface.CBB_TIME,cbb);
        clickToElement(driver,AddInvoiceInterface.OPTION_TIME,value);
    }
